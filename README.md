...
Это бывает очень полезно на этапе, когда вы не знаете IP-адрес, выданный устройству: в свойствах будет указан адрес и двойной клик просто откроет страницу с интерфейсом в браузере.
Контекстное меню:
