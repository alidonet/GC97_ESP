...
[**Скачать прошивку**](bin/GC97_ESP.bin)
...
- [*260705*](bin/)
  - оптимизация кода, улучшение проверок соединений;
  - отмена контроля/сброса TCP;
  - оптимизация ответов веб-сервера (исправление обрывов/потери пакетов на крупных/частых запросах);
  - оптимизация веб-интерфейса для отображения на мобильных устройствах;

- [*250805*](bin/previous/250805/)
  - попытка улучшить отзывчивость веб-сервера с помощью контроля/сброса TCP; вероятно поможет с обрывами/потерями пакетов;

- [*241012*](bin/previous/241012/)
  - небольшие косметические изменения;
  - очередная попытка улучшить отзывчивость веб-сервера с применением "Transfer-Encoding: chunked";

- [*240612*](bin/previous/240612/)
